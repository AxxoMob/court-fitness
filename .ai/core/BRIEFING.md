...
**Where to go next:** `CLAUDE.md` at repo root for full conventions; `.ai/core/WIP.md` for current state; `.ai/sprints/sprint-01/sprint-plan.md` for the upcoming build.
