...
These are not KEs in the court-fitness sense — there is no court-fitness code to host them yet. They are patterns to AVOID recreating. See `.ai/institutional-memory/HARD_LESSONS.md` for the full analysis.
